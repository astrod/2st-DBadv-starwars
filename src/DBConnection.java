...
public class DBConnection implements DBConnectionManager{
	 //Vector의 초기값으로 10을 지정합니다.
    private Vector connections = new Vector(10);
    
    //드라이버 Class
    private String _driver = "com.mysql.jdbc.Driver";
    private String _url = "jdbc:mysql://10.73.45.68:3306/ShardDB";    
    ...
    public static DBConnection getInstance() {
        ...
        if (instance == null) { //생성되어 있지 않다면
            synchronized (DBConnection.class) {//Lock 설정
                if (instance == null) {//수영장이 없으면
                    instance = new DBConnection();//수영장 생성
                }
            }
        }
