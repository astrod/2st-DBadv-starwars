...
public class DBConnection_Third implements DBConnectionManager{
	 //Vector의 초기값으로 10을 지정합니다.
    private Vector connections = new Vector(10);
    
    //드라이버 Class
    private String _driver = "com.mysql.jdbc.Driver";
    private String _url = "jdbc:mysql://10.73.45.73:3306/YODA";    
    
    //계정
    private String _user = "kimjoohwee";
    private String _password = "0000";
    
    private boolean _traceOn = false;
    private boolean initialized = false; 
    private int _openConnections = 10; 
    private static DBConnection_Third instance = null; 
    public DBConnection_Third() {
    }
    /** Use this method to set the maximum number of open connections before
     unused connections are closed.
     */
    public static DBConnection_Third getInstance() {
        //Connection Pool이 생성되어 있는지 검사
        if (instance == null) { //생성되어 있지 않다면
            synchronized (DBConnection_Third.class) {//Lock 설정
                if (instance == null) {//수영장이 없으면
                    instance = new DBConnection_Third();//수영장 생성
                }
            }
        }
