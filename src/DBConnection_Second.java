...
public class DBConnection_Second implements DBConnectionManager{
	 //Vector의 초기값으로 10을 지정합니다.
    private Vector connections = new Vector(10);
    
    //드라이버 Class
    private String _driver = "com.mysql.jdbc.Driver";
    private String _url = "jdbc:mysql://10.211.55.3:3306/LocalDB";    
    
    //계정
    private String _user = "jongun";
    private String _password = "next123!@#";
    
    private boolean _traceOn = false;
    private boolean initialized = false; 
    private int _openConnections = 10; 
    private static DBConnection_Second instance = null; 
    public DBConnection_Second() {
    }
    /** Use this method to set the maximum number of open connections before
     unused connections are closed.
     */
    public static DBConnection_Second getInstance() {
        //Connection Pool이 생성되어 있는지 검사
        if (instance == null) { //생성되어 있지 않다면
            synchronized (DBConnection_Second.class) {//Lock 설정
                if (instance == null) {//수영장이 없으면
                    instance = new DBConnection_Second();//수영장 생성
                }
            }
        }
